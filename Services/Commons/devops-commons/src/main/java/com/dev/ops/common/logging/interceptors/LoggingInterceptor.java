...
public class LoggingInterceptor {
	...
	public void addContextInfoToThreadLocal(final JoinPoint joinPoint) throws Throwable {
		ContextInfo contextInfo = getContextInfoFromMethod(joinPoint);
		ContextThreadLocal.set(contextInfo);
	}

	@Before("execution(* uk.gov.nhs.digital.ers.service..*.*(..)) && !execution(* com.dev.ops.common.orika..*.*(..))")
	...
	@After("execution(* uk.gov.nhs.digital.ers.service..*.*(..)) && !execution(* com.dev.ops.common.orika..*.*(..))")
	...
	@Around("execution(* uk.gov.nhs.digital.ers.service..controllers..*.*(..))")
