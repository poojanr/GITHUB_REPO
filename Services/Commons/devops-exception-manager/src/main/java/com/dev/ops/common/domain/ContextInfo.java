...
public class ContextInfo {
	...
	public static ContextInfo toContextInfo(String stringContextInfo) {
		final ContextInfo contextInfo = new ContextInfo();
		if(!StringUtils.endsWith(stringContextInfo, LoggingConstants.WhitespaceLiterals.ATTRIBUTES_SEPERATOR)) {
			stringContextInfo += LoggingConstants.WhitespaceLiterals.ATTRIBUTES_SEPERATOR;
		}
		...
		contextInfo.setReferralNumber(StringUtils.substringBetween(stringContextInfo, REFERRAL_NUMBER + LoggingConstants.WhitespaceLiterals.NAME_VALUE_SEPERATOR, LoggingConstants.WhitespaceLiterals.ATTRIBUTES_SEPERATOR));
		...
		contextInfo.setTransactionRequestedByUsername(StringUtils.substringBetween(stringContextInfo, TRANSACTION_REQUESTED_BY_USERNAME + LoggingConstants.WhitespaceLiterals.NAME_VALUE_SEPERATOR, LoggingConstants.WhitespaceLiterals.ATTRIBUTES_SEPERATOR));
		return contextInfo;
	}
	...
	public String toString() {
		...
		if(this.getReferralNumber() != null) {
			stringContextInfo.append(REFERRAL_NUMBER).append(LoggingConstants.WhitespaceLiterals.NAME_VALUE_SEPERATOR).append(this.getReferralNumber()).append(LoggingConstants.WhitespaceLiterals.ATTRIBUTES_SEPERATOR);
		}
