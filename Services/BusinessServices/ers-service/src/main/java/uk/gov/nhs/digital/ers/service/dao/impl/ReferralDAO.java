...
public interface ReferralDAO extends GenericDAO<ReferralRequest> {
	ReferralRequest fetchReferralByNumber(String referralNumber) throws DefaultWrappedException;
}