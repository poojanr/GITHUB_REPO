...
@Component
public class ReferralMappingConfigurer implements MappingConfigurer {

	@Override
	public void configure(final MapperFactory factory) {

		//@formatter:off
		factory.classMap(ReferralRequest.class, ReferralRequestDTO.class)
		.field("patient.nhsNumber", "nhsNumber")
