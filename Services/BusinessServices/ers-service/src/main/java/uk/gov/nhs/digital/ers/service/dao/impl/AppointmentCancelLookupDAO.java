...
public interface AppointmentCancelLookupDAO extends GenericDAO<AppointmentCancelReasonLookup> {
	List<AppointmentCancelReasonLookup> fetchCancelReasons();

	AppointmentCancelReasonLookup fetchByReasons(final String cancelReason);
}