...
@Component
public class HospitalMappingConfigurer implements MappingConfigurer {

	@Override
	public void configure(final MapperFactory factory) {

		//@formatter:off
		factory.classMap(Hospital.class, HospitalDTO.class)
		.field("hospitalStatus.status", "status")
		.byDefault()
		.register();
		//@formatter:on
	}
